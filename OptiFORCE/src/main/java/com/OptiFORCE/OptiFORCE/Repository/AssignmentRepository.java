...
import com.OptiFORCE.OptiFORCE.Entity.Employee; // New import needed for sum query
...
public interface AssignmentRepository extends JpaRepository<Assignment, Long> {
    ...
    @Query
            ("SELECT COALESCE(SUM(a.optimizedAssignedHours), 0) FROM Assignment a WHERE a.employee = ?1")
